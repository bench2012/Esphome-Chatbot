...
is just an ESP32S3-N16R8 and some peripherals; an i2s Micophone, an i2s Mono D-Amp with speaker connector, three buttons and a WS2812. It has pin out for 3.3v/GND, i2c (SDA/GPIO41 and SCL/GPIO42) , VIn (5V??), TX/RX.  
